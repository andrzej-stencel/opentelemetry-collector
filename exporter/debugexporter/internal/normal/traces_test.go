...
func TestMarshalTraces(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expected: `ResourceSpans #0 SchemaUrl=https://opentelemetry.io/resource-schema-url resourceKey1=resourceValue1 resourceKey2=false
ScopeSpans #0 SchemaUrl=http://opentelemetry.io/scope-schema-url scopeKey1=scopeValue1 scopeKey2=true
